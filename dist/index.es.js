...
var MimimizeIcon = function MimimizeIcon(props) {
  return props.isWin ? React.createElement(
    "svg",
    {
      version: "1.1",
      "aria-hidden": "true",
    ...
    React.createElement("path", { d: "M 0,5 10,5 10,6 0,6 Z" })
  ) : React.createElement(
    "svg",
    { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16" },
    React.createElement("path", { d: "M7 3v4H4l3.156 4H4v2h8v-2H8.844L12 7H9V3z", style: { marker: "none" }, overflow: "visible" }),
    React.createElement("text", { x: "613.992", y: "426.851", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "-1401.69", y: "1250.896", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "-474.763", y: "195.667", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "417.863", y: "-261.333", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "444.346", y: "-306.364", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "-1204.137", y: "-314.333", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "410.171", y: "-616.333", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "2052.752", y: "76.336", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "2079.236", y: "31.305", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "430.752", y: "23.336", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "2045.06", y: "-278.664", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "-605.797", y: "-29.818", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "-2621.479", y: "794.227", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" }),
    React.createElement("text", { x: "-726.195", y: "896.876", fontSize: "14", fontWeight: "400", opacity: ".8", fontFamily: "Bitstream Vera Sans", transform: "translate(-293 -188)" })
  );
};
...
var RestoreIcon = function RestoreIcon(props) {
  return props.isWin ? React.createElement(
    ...
    React.createElement(
      "g",
      null,
      React.createElement("path", { d: "M14 8l-2.25-2.223 1.714-1.715c.013-.012.015-.013.027-.026.38-.42.379-1.068-.027-1.474a1.07 1.07 0 0 0-1.473-.053l-.214.214-1.554 1.527L8 2v6zM8 14V8H2l2.25 2.25-1.714 1.714-.027.027c-.38.42-.379 1.068.027 1.473.405.406 1.08.434 1.5.054l.187-.214 1.554-1.554z", style: { marker: "none" }, overflow: "visible" })
    )
  );
};
...
var MaximizeIcon = function MaximizeIcon(props) {
  return props.isWin ? React.createElement(
    ...
    "svg",
    { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16" },
    React.createElement("path", { d: "M8 2l2.25 2.223-1.714 1.714-.027.027c-.38.42-.379 1.068.027 1.474a1.07 1.07 0 0 0 1.473.053l.214-.214 1.554-1.527L14 8V2zM2 8v6h6l-2.25-2.25 1.714-1.714.027-.027c.38-.42.379-1.068-.027-1.473-.405-.406-1.08-.434-1.5-.054l-.187.214-1.554 1.554z", style: { marker: "none" }, overflow: "visible" })
  );
};
...
var CloseIcon = function CloseIcon(props) {
  return props.isWin ? React.createElement(
    ...
    "svg",
    { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16" },
    React.createElement("path", { d: "M7.97 6.556L10.5 4 12 5.5 9.401 7.987 12 10.5 10.5 12 7.987 9.401 5.5 12 4 10.5 6.586 8 4 5.5 5.5 4l2.47 2.556z", style: { marker: "none" }, overflow: "visible" })
  );
};
  ...
  createClass(MenuItem, [{
    ...
    value: function _handleClick(e) {
      ...
      switch (menuItem.type) {
        ...
        case 'checkbox':
          {
            ...
            menuItem.click(newMenuItem, remote.getCurrentWindow(), _extends({}, e, { menuBar: this.props.menuRef }));
        ...
        case 'radio':
          {
            ...
            menuItem.click(_newMenuItem, remote.getCurrentWindow(), _extends({}, e, { menuBar: this.props.menuRef }));
            if (!menuItem.checked) {
              // TODO: Change Checked State
        ...
        default:
          e.persist();
          menuItem.click(this.props.menuItem, remote.getCurrentWindow(), _extends({}, e, { menuBar: this.props.menuRef }));
          break;
      }
    }
  }, {
    ...
    value: function _generateHorizontalMenu() {
      ...
      var menuList = menuObj.map(function (menuItem, i) {
        return React.createElement(
          ...
          _this2.state.clicked && i === _this2.state.focusing && React.createElement(MenuList, {
            menuRef: _this2,
      ...
      menuList.splice(overflowIndex, 0, React.createElement(
        MenuButton,
        {
          key: 'more',
          label: '...',
        ...
        this.state.clicked && overflowIndex === this.state.focusing && React.createElement(MenuList, {
          menuRef: this,
    ...
    value: function _generateVerticalMenu() {
      ...
      return React.createElement(
        MenuButton,
        {
          ...
          label: React.createElement(MenuIcon, null),
          enabled: true
        },
        this.state.clicked && this.state.focusing === 0 && React.createElement(MenuList, {
          menuRef: this,
          changeCheckState: this._changeCheckState,
...
var Bar = function (_React$Component) {
  ...
  createClass(Bar, [{
    ...
    value: function handleDoubleClick(e) {
      ...
      var _electron$screen$getD = electron.screen.getDisplayNearestPoint({ x: winRect.x, y: winRect.y }),
  ...
  createClass(WindowControls, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.props.windowActions && React.createElement(
          'div',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(MimimizeIcon, { isWin: isWin })
          ),
          React.createElement(
            Button,
            {
            ...
            isMaximized ? React.createElement(RestoreIcon, { isWin: isWin }) : React.createElement(MaximizeIcon, { isWin: isWin })
          ),
          React.createElement(
            Button,
            {
            ...
            React.createElement(CloseIcon, { isWin: isWin })
          )
        )
      );
    }
...
var currentWindow$2 = electron.remote.getCurrentWindow();
    ...
    value: function _generatePlatformChildren(_ref) {
      ...
      if (platform === 'darwin') {
        return React.createElement(
          ...
          React.createElement(ResizeHandle, { height: currentTheme.barHeight, left: true }),
          icon && currentTheme.showIconDarwin && React.createElement(Icon, {
            notWin: true,
            src: icon
          }),
      ...
      if (currentTheme.menuStyle === 'stacked') {
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(ResizeHandle, { top: true }),
            React.createElement(ResizeHandle, { height: currentTheme.winBarHeight, left: true }),
            platform !== 'win32' && currentTheme.controlsLayout === 'left' && React.createElement(WindowControls, {
            ...
            children,
            (platform === 'win32' || platform !== 'win32' && currentTheme.controlsLayout === 'right') && React.createElement(WindowControls, {
              isWin: platform === 'win32',
              theme: currentTheme,
              disableMinimize: disableMinimize,
              disableMaximize: disableMaximize,
